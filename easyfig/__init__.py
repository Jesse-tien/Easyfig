...
- 14. make_example: 生成示例代码，例如make_example("data_lines")。支持的函数有data_lines、draw_lines、draw_3D、draw_max_area、draw_detail_area。
...
14. **make_example**: Generate example code, e.g., make_example("data_lines"). Supported functions include data_lines, draw_lines, draw_3D, draw_max_area, and draw_detail_area.
